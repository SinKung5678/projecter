      ...
      <div className={styles.container}>
        <div className={styles.hero_content}>
          <div className={styles.hero_info}>
            ...
            <h3 className={styles.text_2}>Mr. thanapon phonthong</h3>
            ...
            <ul className={styles.hero_social}>
              <li>
                <a href="https://github.com/SinKung5678">
                  <FaGithub />
                </a>
              </li>
              <li>
                <a href="https://facebook.com/Aom.Sin.Kung/">
                  <FaSquareFacebook />
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com/aom_sin_kung5678/">
                  <FaInstagram />
                </a>
              </li>
            </ul>
